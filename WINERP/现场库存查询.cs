...
{
    public partial class 现场库存查询 : UserControl
    {
        public 现场库存查询()
        {
            InitializeComponent();
        ...
        {
            string strsql = @"Server=ASUS-PC;database=WINERP;Persist Security Info=True;uid=sa;Password=guoang168168";//数据库链接字符串  
            string sql = "TEST";//要调用的存储过程名  
